  ...
  return (
    <Layout title={title} hasTabBar={hasTabBar} canGoBack={canGoBack}>
      <div className="p flex flex-col space-y-5 py-10">
        ...
        <button className="fixed bottom-0 right-5 cursor-pointer rounded-full bg-orange-400 p-4 text-white shadow-xl transition-colors duration-300 hover:bg-orange-500">
          <svg
            className="h-6 w-6"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
