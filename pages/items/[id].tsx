...
/***********
 ...
 <div className="h-96 bg-slate-300">큰 네모</div>

<div className="flex">
	<div className="w-12 h-12 rounded-full bg-slate-300"></div>
	<div>
		<div className="text-sm font-medium text-gray-700">Steve Jebs</div>
		<div className="text-xs font-medium text-gray-500">View profile &rarr;</div>
	</div>
</div>
