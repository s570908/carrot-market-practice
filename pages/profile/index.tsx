...
const Reviews = () => {
  const { data } = useSWR<ReviewsResponse>("/api/reviews", fetcher, { suspense: true });
  console.log("Profile--useSWR-/api/reviews, data: ", data);
  {
    return (
      <div>
      ...
      <div className="px-4 py-3">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            ...
            {/* <span className="text-gray-700 font-sm">Edit profile &rarr;</span> */}
          </div>
        </div>
        ...
        <CustomSuspense
          fallback={<BackdropSpinner bgColor="white" color="red" position="relative" open={true} />}
        >
          <Reviews />
        </CustomSuspense>
        {/* <Suspense
