...
export const ModButton: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-blue-600 hover:bg-blue-700 text-white focus:ring-blue-300 disabled:opacity-60",
    secondary:
      "bg-gray-500 hover:bg-gray-600 text-white focus:ring-gray-300 disabled:opacity-60",
    danger:
      "bg-red-600 hover:bg-red-700 text-white focus:ring-red-300 disabled:opacity-60",
    outline:
