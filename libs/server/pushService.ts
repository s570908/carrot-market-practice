 ...
 */
export async function retryPushNotification(userId: number, payload: any, retries = 3): Promise<boolean> {
...
// 이 함수는 실제 API 엔드포인트에서 사용됩니다.
// 예: pages/api/alarm/trigger.ts에서
// await retryPushNotification(alarm.userId, pushPayload);
